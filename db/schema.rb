...
ActiveRecord::Schema.define(version: 2019_12_05_195329) do
  ...
  create_table "domains", force: :cascade do |t|
    ...
    t.index ["domain"], name: "index_domains_on_domain", using: :hash
  end

  create_table "passwords", force: :cascade do |t|
    t.string "password", null: false
    t.index ["password"], name: "index_passwords_on_password", using: :hash
  end
  ...
  create_table "usernames", force: :cascade do |t|
    ...
    t.index ["username"], name: "index_usernames_on_username", using: :hash
  end
